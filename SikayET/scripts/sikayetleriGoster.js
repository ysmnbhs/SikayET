...
let tarih = new Date().getDate()+'/'+(new Date().getMonth()+1)+'/'+new Date().getFullYear() + "   " +new Date().getHours() + ":" + new Date().getMinutes() ;
...
function showHtml() {
    ...
    <h4 class="text-center"> ${tumSikayetlerLocal.length} tane şikayet var </h4>
    ...
    let i = 0;
    for (i == 0; i <= tumSikayetlerLocal.length; i++) {
        ...
        <div id="${"sikayet-card" + i}" class="sikayet-card">
        <div class="ust-kisim">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a type="button" id="${"sil" + i}" class="dropdown-item sil">Sil</a></li>
        ...
        <div class="yorum-link">
          <button id="${"cevapla-button" + i}" type="button" onclick=" ${"cevaplandi" +i +"()"} " class="cevapla-button" data-bs-toggle="modal" data-bs-target="#exampleModal">Cevapla <img class="ok-ikon" src="../pictures/cevapla.png"></button>
        </div>

        <div id="firma-cevap" class="firma-cevap gizlenmis-oge">
         <h5>${marka} </h5>
         <p class = "${"markanin-cevabi" +i}"></p>
        </div>
    ...
    let sikayetCards = document.querySelector("#sikayet-card0")
    sikayetCards.style.backroundColor = "red";
